                    ...
                    do {
                        ...
                        switch (escolha.toUpperCase()) {
                            ...
                            case "F":
                                ...
                                PessoaFisica pessoaIncluir = new PessoaFisica((int) seq.getValue("seq_pessoa_id"),nome, logradouro, 
                            ...
                            case "J":                       
                                ...
                                PessoaJuridica pessoaJIncluir = new PessoaJuridica((int) seq.getValue("seq_pessoa_id"),nomej,
